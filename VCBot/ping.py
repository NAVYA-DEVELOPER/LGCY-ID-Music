...
@Client.on_message(contact_filter & filters.command(["/ping"])
...
@Client.on_message(contact_filter & filters.command(["/restart"])
...
@Client.on_message(contact_filter & filters.command(["/help"])
