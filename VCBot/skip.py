...
@Client.on_message(contact_filter & filters.command(["/skip"])
...
@Client.on_message(contact_filter & filters.command(["/end", "/stop"])
...
@Client.on_message(contact_filter & filters.command(["/pause"])
...
@Client.on_message(contact_filter & filters.command(["/resume"])
